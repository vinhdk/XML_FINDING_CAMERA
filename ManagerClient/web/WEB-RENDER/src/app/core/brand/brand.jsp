...
<html>
    <head>
        ...
        <script type="module" src="WEB-RENDER/src/app/core/brand/brand.js"></script>
        <script>
                ...
                <div class="col-3 mt-3">
                    <div class="row h-20 card bg-white radius-10">
                        ...
                        <div class="col-3 start-2 end-5">
                            <app-brand-create></app-brand-create>
                        </div>
                        <div class="col-4">
                            <app-brand-update></app-brand-update>
                        </div>
                        <div class="col-3">
                            <button id="brand-delete-button" class="btn btn-danger w-100-per" >DELETE</button>
                        </div>
                    </div>
