...
<html>
    <head>
        ...
        <script type="module" src="WEB-RENDER/src/app/core/category/category.js"></script>
        <script>
            ...
            <div class="row">
                <div class="col-3 mt-3">
                    <div class="row h-20 card bg-white radius-10">
                        ...
                        <div class="col-3">
                            <button id="category-delete-button" class="btn btn-danger w-100-per" >DELETE</button>
                        </div>
                    </div>
