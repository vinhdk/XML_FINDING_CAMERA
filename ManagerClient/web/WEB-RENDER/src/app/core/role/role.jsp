...
<html>
    <head>
        ...
        <script type="module" src="WEB-RENDER/src/app/core/role/role.js"></script>
        <script>
            ...
            <div class="row">
                <div class="col-3 mt-3">
                    <div class="row h-20 card bg-white radius-10">
                        ...
                        <div class="col-4">
                            <app-role-update></app-role-update>
                        </div>
                        <div class="col-3">
                            <button id="role-delete-button" class="btn btn-danger w-100-per" >DELETE</button>
                        </div>
                    </div>
