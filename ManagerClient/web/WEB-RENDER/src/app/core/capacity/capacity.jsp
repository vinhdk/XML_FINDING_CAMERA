...
<html>
    <head>
        ...
        <script type="module" src="WEB-RENDER/src/app/core/capacity/capacity.js"></script>
        <script>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-3 mt-3">
                    <div class="row h-20 card bg-white radius-10">
                        ...
                        <div class="col-3 start-2 end-5">
                            <app-capacity-create></app-capacity-create>
                        </div>
                        <div class="col-4">
                            <app-capacity-update></app-capacity-update>
                        </div>
                        <div class="col-3">
                            <button id="capacity-delete-button" class="btn btn-danger w-100-per" >DELETE</button>
                        </div>
                    </div>
                ...
                <div class="col-9 bg-white mt-3 h-85">
                    <app-capacity-list></app-capacity-list>
                </div>
            </div>
        </div>
    </app-layout>
